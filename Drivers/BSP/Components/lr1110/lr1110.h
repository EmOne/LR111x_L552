...
typedef struct
{
	lr1110_radio_pkt_type_t packet_type;  //!< Packet to which the modulation parameters are referring to.
    struct
    {
        lr1110_radio_mod_params_gfsk_t gfsk;
        lr1110_radio_mod_params_lora_t lora;
...
typedef struct
{
	lr1110_radio_pkt_type_t packet_type;  //!< Packet to which the packet parameters are referring to.
    struct
    {
    	lr1110_radio_pkt_params_gfsk_t gfsk;
        lr1110_radio_pkt_params_lora_t lora;
